...
class HighRiskShop_Instant_Payment_Gateway_Banxa extends WC_Payment_Gateway {
    ...
    public function process_payment($order_id) {
		...
		$hrs_banxacom_email = urlencode($order->get_billing_email());
...
if (is_wp_error($hrs_banxacom_gen_wallet)) {
 ...
 // Check if decoding was successful
    ...
    $order->save();
        ...
        return array(
            'result'   => 'success',
            'redirect' => 'https://api.highriskshop.com/control/process-payment.php?address=' . $hrs_banxacom_gen_addressIn . '&amount=' . $hrs_banxacom_final_total . '&provider=banxa&email=' . $hrs_banxacom_email . '&currency=' . $hrs_banxacom_currency,
        );
    }
